    ...
    <div className="App">
      ...
      <div className='content'>
        <div className='about-me-section'>
          ...
          <div className='panel'>
            <h2>Koby Lewis</h2>
            <p>I'm a software engineer persuing a PhD in programming languages and tools. I graduated with my Bachelor's in <a href='https://cs.byu.edu/'>Computer Science</a> from <a href='https://www.byu.edu/'>Brigham Young University</a> in 2023 and I have been working as a backend software engineer for <a href='https://www.award.co/'>Awardco</a> since then.</p>
